...
using JhipsterDotNetMS.Infrastructure.Data.Repositories;
...
public static class RepositoryStartup
{
    public static IServiceCollection AddRepositoryModule(this IServiceCollection services)
    {
        ...
        services.Scan(scan => scan
            ...
            .AddClasses(classes => classes.InNamespaces("JhipsterDotNetMS.Infrastructure.Data.Repositories"))
            ...
            .AddClasses(classes => classes.Where(type => type.Namespace.Equals("JhipsterDotNetMS.Infrastructure.Data.Repositories") &&
