...
using JhipsterDotNetMS.Security;
using JhipsterDotNetMS.Test.Configuration;
...
namespace JhipsterDotNetMS.Test.Setup;
    ...
    where TEntryPoint : class, IStartup, new()
{
    ...
    {
        builder
            .UseSolutionRelativeContentRoot("src/JhipsterDotNetMS")
